...
public class LotteryPosOrderDBApp extends Application {
    ...
    public TilePane getMenuSelectionContainer() {
        ...
        Label label = new Label("商品價格\n分類");
        label.setPrefSize(170, 150);
        ...
        conntainerCategoryMenuBtn.setStyle("-fx-background-color: #D0181F;");
        conntainerCategoryMenuBtn.setAlignment(Pos.TOP_CENTER);
        conntainerCategoryMenuBtn.getChildren().add(label);
   ...
   btndel.setOnAction(new EventHandler<ActionEvent>() {
    ...
    public HBox get_root_pane() {
        ...
        root3.setStyle("-fx-background-color: #00AAC8;");
        //root3.setStyle("-fx-background-color: #592B5F;");
